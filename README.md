...
CI/CD Test Selection Tool je alat koji optimizuje proces testiranja unutar CI/CD pipeline-a. Projekat se sastoji od dva glavna direktorijuma: cppcheck, selection_tool.
...
- selection_tool: Direktorijum koji sadrži implementaciju Selection Tool alata. Alat analizira Pull Request-ove i na osnovu pokrivenosti koda odabira testove koji trebaju biti pokrenuti na osnovu promena u kodu. I implementacija alata za praćenje pokrivenosti koda. Alat prati koje delove koda pokrivaju pojedinacni testovi i generiše izveštaje u JSON formatu.
